...
using DataVerse = Microsoft.Dynamics.CRM;
using System;
...
namespace DV_ODataClient
{
    internal class Program
    {
        async Task WhoAmI()
        {
            var serviceRoot = "https://orgab450c0a.api.crm.dynamics.com/";
            var context = new DataVerse::System(new Uri(serviceRoot));
